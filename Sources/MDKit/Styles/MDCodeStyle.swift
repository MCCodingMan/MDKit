...
extension MDCodeStyle {
    ...
    public struct LanguageViewStyle: Sendable {
        /// 自定义语言视图
        public var view: (@MainActor @Sendable (String?) -> AnyView)?
        /// 语言文本样式
        ...
        /// 创建语言标签样式
        public init(view: (@MainActor @Sendable (String?) -> AnyView)? = nil, text: MDTextStyle, padding: @escaping @Sendable () -> [Edge : CGFloat?], background: @escaping @Sendable () -> Color) {
            self.view = view
            self.text = text
    ...
    public struct ContentViewStyle: Sendable {
        /// 自定义代码内容视图
        public var view: (@MainActor @Sendable (String, String?) -> AnyView)?
        /// 语法高亮处理
        ...
        public var padding: @Sendable () -> [Edge: CGFloat?]
        /// 文本样式
        public var textFontSize: @Sendable () -> CGFloat
        
        public var codeColor: @Sendable () -> UIColor
        /// 背景色
        public var background: @Sendable () -> Color
        
        /// 创建内容视图样式
        public init(view: (@MainActor @Sendable (String, String?) -> AnyView)? = nil, highlightCode: (@Sendable (String, String?) async -> NSAttributedString)? = nil, codeSingleHeight: @escaping @Sendable () -> CGFloat, padding: @escaping @Sendable () -> [Edge : CGFloat?], textFontSize: @escaping @Sendable () -> CGFloat, codeColor: @escaping @Sendable () -> UIColor, background: @escaping @Sendable () -> Color) {
            self.view = view
